...
SELECT learning_materials.*, course.course_title,users.name AS teacher_name,users.avatar AS teacher_avatar FROM learning_materials JOIN course ON learning_materials.course_id = course.id 
