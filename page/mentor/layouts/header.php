...
<header id="page-header">
        ...
        <div class="content-header">
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand" href="<?=url('/mentor/dashboard')?>"><img src="<?=asset('images/kasipaham.svg')?>" alt="kasipaham logo" height="32"></a>
            <!-- END Toggle Sidebar -->
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block ms-2">
              <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle" src="<?=Storage::getAvatar(Session::auth()['avatar'],Session::auth()['name'])?>" alt="Header Avatar" style="width: 21px;">
                <span class="d-none d-sm-inline-block ms-2"><?=Session::auth()['name']?></span>
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                ...
                <div class="p-2">
                  <a class="dropdown-item d-flex align-items-center justify-content-left" href="<?=url('/mentor/profile')?>">
