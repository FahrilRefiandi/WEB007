        ...
        <main id="main-container">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            <li class="breadcrumb-item">
                                <a class="link-fx" href="<?= url('/student/course') ?>">Courses</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="<?= url('/student/detail-course?id=' . $data1['id']) ?>"><?= $data1['course_title'] ?></a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">
                                <?= $data2['title'] ?>
                            </li>
            ...
            <div class="content content-boxed">
                ...
                <div class="block block-rounded">
                    <div class="block-content fs-sm p-5 justify-content-center" id="containerDetailMeet">
                    <?= $data2['embed_video'] ?>
                    </div>
